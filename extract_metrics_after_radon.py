...
cc_data  = rodar_radon(["radon", "cc",  "./meu-projeto", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./meu-projeto", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./meu-projeto", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./meu-projeto", "-j"])
